...
namespace Brewdogger.Api.Persistence.Migrations
{
    ...
    [Migration("20181108204145_SeedBreweries")]
    partial class SeedBreweries
    {
            ...
            modelBuilder.Entity("Brewdogger.Api.Entities.Beer", b =>
                {
                    ...
                    b.HasData(
                        new { BeerId = 1, Abv = 7.2, BeerName = "Hexagenia", BeerStyle = "Ipa", Ibu = 80 },
                        new { BeerId = 2, Abv = 6.0, BeerName = "Pliny the Elder", BeerStyle = "DoubleIpa", Ibu = 100 },
                        new { BeerId = 3, Abv = 3.8, BeerName = "Coors Light", BeerStyle = "Lager", Ibu = 12 }
                    );
                });
